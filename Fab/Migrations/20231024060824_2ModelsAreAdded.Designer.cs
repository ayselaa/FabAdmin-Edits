...
namespace Fab.Migrations
{
    ...
    [Migration("20231024060824_2ModelsAreAdded")]
    partial class _2ModelsAreAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fab.Models.DryMixesFolder.DryMix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fab.Models.DryMixesFolder.DryMixImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DryMixImages");
                });

            modelBuilder.Entity("Fab.Models.DryMixesFolder.DryMixTranslate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DryMixTranslates");
                });

            modelBuilder.Entity("Fab.Models.GipsFolder.Gips", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fab.Models.GipsFolder.GipsImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GipsImages");
                });

            modelBuilder.Entity("Fab.Models.GipsFolder.GipsTranslate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GipsTranslates");
                });

            modelBuilder.Entity("Fab.Models.GluesFolder.Glue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fab.Models.GluesFolder.GlueImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GlueImages");
                });

            modelBuilder.Entity("Fab.Models.GluesFolder.GlueTranslate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fab.Models.DryMixesFolder.DryMixImage", b =>
                {
                    b.HasOne("Fab.Models.DryMixesFolder.DryMix", "DryMix")
                        .WithMany("DryMixImages")
                        .HasForeignKey("DryMixId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fab.Models.GipsFolder.GipsImage", b =>
                {
                    b.HasOne("Fab.Models.GipsFolder.Gips", "Gips")
                        .WithMany("GipsImages")
                        .HasForeignKey("GipsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Fab.Models.GluesFolder.GlueImage", b =>
                {
                    b.HasOne("Fab.Models.GluesFolder.Glue", "Glue")
                        .WithMany("GlueImages")
